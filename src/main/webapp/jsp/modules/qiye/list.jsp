...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>企业管理</span></li>
								<li class="breadcrumb-item active"><span>企业列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">企业列表</h3>							
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
									<label>
										企业账号
									</label>
									<input type="text" id="qiyezhanghaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>头像</th>
											<th onclick="sort('lianxiren')">联系人<i id="lianxirenIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('lianxidianhua')">联系电话<i id="lianxidianhuaIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('qiyeyouxiang')">企业邮箱<i id="qiyeyouxiangIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('qiyedizhi')">企业地址<i id="qiyedizhiIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#qiyezhanghaoSearch').val() != null && $('#qiyezhanghaoSearch').val() != ''){
				searchForm.qiyezhanghao ="%" +  $('#qiyezhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("qiye/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				qiyezhanghao : searchForm.qiyezhanghao,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var qiyeyouxiangCell  = document.createElement('td');

						 qiyeyouxiangCell.innerHTML = item.qiyeyouxiang;


			row.appendChild(qiyeyouxiangCell);
			var qiyedizhiCell  = document.createElement('td');

						 qiyedizhiCell.innerHTML = item.qiyedizhi;


			row.appendChild(qiyedizhiCell);
		...
		// 删除
        function shenhe(id) {
            var mymessage = confirm("真的要同意审核吗？");
            if (mymessage == true) {
				http("qiye/shenhe?id="+id,"POST",{},(res)=>{
					if(res.code == 0){
						getDataList();
						alert('审核成功');
					}
