...
<style>
	...
	body {
				background-image: url(http://codegen.caihongy.cn/20210115/ebf720f5505a495c82945e44a728a829.jpg) !important;
	...
	<div class="container">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">企业账号</label> 
							<input type="text" name="qiyezhanghao" placeholder="企业账号" class="form-control-i">
							</div>
																								<div class="form-group">
							...
							<input type="text" name="qiyemingcheng" placeholder="企业名称" class="form-control-i">
							</div>
																																			<div class="form-group">
							<label class="label">联系人</label> 
							<input type="text" name="lianxiren" placeholder="联系人" class="form-control-i">
							</div>
																								<div class="form-group">
							...
							<input type="text" name="qiyeyouxiang" placeholder="企业邮箱" class="form-control-i">
							</div>
																								<div class="form-group">
							<label class="label">企业地址</label> 
							<input type="text" name="qiyedizhi" placeholder="企业地址" class="form-control-i">
							</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				$.ajax({ 
					type: "POST",
					url: baseUrl + "qiye/register",
					contentType: "application/json",
					data:json,
					beforeSend: function(xhr) {xhr.setRequestHeader("token", window.sessionStorage.getItem('token'));},
					success: function(res){    
						if(res.code == 0){
						alert("注册成功!,请耐心等待审核结果，只有审核通过后才可以登录");
